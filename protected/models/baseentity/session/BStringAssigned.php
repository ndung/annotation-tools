 ...
 * @property User $user
 */
class BStringAssigned extends CActiveRecord {

    /**
     * @return string the associated database table name
     */
    public function tableName() {
        return 'string_assigned';
    }
    ...
    public function rules() {
        ...
        return array(
            array('userID, corpusParseTreeStringID', 'required'),
            array('userID, corpusParseTreeStringID', 'numerical', 'integerOnly' => true),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('ID, userID, corpusParseTreeStringID', 'safe', 'on' => 'search'),
        );
    }
     ...
     * @return BStringAssigned the static model class
     */
